...
<body>
  ...
  <header>
    ...
    <!-- Profile icon that redirects to CustomerProfile.php -->
    <a href="CustomerProfile.php">
        <img src="<?php echo isset($_SESSION['profile_image']) ? $_SESSION['profile_image'] : 'image/default-profile.png'; ?>" 
             alt="Profile" 
             class="profile-icon">
    </a>
